        ...
        CultureInfo culture, CancellationToken cancellationToken)
    {
        ...
        foreach (TestRunDto value in values)
        {
            ...
            result.Add(new AdoTestRun
            {
                ...
                StageName = value.PipelineReference?.StageReference?.StageName,
                PhaseName = value.PipelineReference?.PhaseReference?.PhaseName,
                JobName = value.PipelineReference?.JobReference?.JobName,
