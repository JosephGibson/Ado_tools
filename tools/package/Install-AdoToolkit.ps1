...
Uses AdoToolkit-0.3.0.zip.sha256 from the same folder as the zip.

.EXAMPLE
.\Install-AdoToolkit.ps1 -Path .\AdoToolkit-0.3.0.zip -Sha256 <64 hexadecimal characters> -WhatIf
#>
